...
window.requestAnimationFrame(function() {setTimeout(() => {
                                                                                                                var ele = document.getElementById('pro-gallery-comp-lz9tdkbv3');
...
gallerySizePx:0|placeGroupsLtr:false")(ele);
                                                                                                                ...
                                                                                                                var layoutFixerUrl = '/_serverless/pro-gallery-css-v4-server/layoutCss?ver=2&id=comp-lz9tdkbv3&items=3575_640_800|3562_640_426|
...
document.getElementById('layout-fixer-style-comp-lz9tdkbv3').setAttribute('href', encodeURI(layoutFixerUrl));
                                                                                                            }, 0);
                                                                                                        });
                                                                                                    } catch (e) {
